        ...
        while(running):
            for event in pygame.event.get():
                if event.type==KEYDOWN:
                    ...
                    if ((event.key==K_2 or event.key==K_KP2) and pause == False):
                        if random_value==2:
                            self.score=self.score+10
                            self.play_sound("collision")
                            time1=time1-0.01
                    ...
                    if ((event.key==K_3 or event.key==K_KP3) and pause == False):
                        if random_value==3:
                            self.score=self.score+10
                            self.play_sound("collision")
                            time1=time1-0.01
                    ...
                    if ((event.key==K_4 or event.key==K_KP4) and pause == False):
                        if random_value==4:
                            self.score=self.score+10
                            self.play_sound("collision")
                            time1=time1-0.01
                    ...
                    if ((event.key==K_5 or event.key==K_KP5) and pause == False):
                        if random_value==5:
                            self.score=self.score+10
                            self.play_sound("collision")
                            time1=time1-0.01
                    ...
                    if ((event.key==K_6 or event.key==K_KP6) and pause == False):
                        if random_value==6:
                            self.score=self.score+10
                            self.play_sound("collision")
                            time1=time1-0.01
                    ...
                    if ((event.key==K_7 or event.key==K_KP7) and pause == False):
                        if random_value==7:
                            self.score=self.score+10
                            self.play_sound("collision")
                            time1=time1-0.01
                    ...
                    if ((event.key==K_8 or event.key==K_KP8) and pause == False):
                        if random_value==8:
                            self.score=self.score+10
                            self.play_sound("collision")
                            time1=time1-0.01
                    ...
                    if ((event.key==K_9 or event.key==K_KP9) and pause == False):
                        if random_value==9:
                            self.score=self.score+10
                            self.play_sound("collision")
                            time1=time1-0.01
